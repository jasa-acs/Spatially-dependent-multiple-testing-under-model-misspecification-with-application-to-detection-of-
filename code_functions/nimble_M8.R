...
Hmat <- cbind(rep(1,M), matrix( rnorm(M*10), ncol = 10 )) # dummy EOF matrix

#===============================================================
# M7: EOF structure with skew-t discrepancy, 10 EOFs
#===============================================================
...
nim_model <- nimbleModel(
  code = nim_code, 
  constants = list( M = M, Ne = 10 + 1 ),
  inits = list( beta = rep(0, 10 + 1), sigma = 1, delta = 0, 
