...
Hmat <- cbind(rep(1,M), matrix( rnorm(M*50), ncol = 50 )) # dummy EOF matrix

#===============================================================
# M7: EOF structure with skew-t discrepancy, 50 EOFs
#===============================================================
...
nim_model <- nimbleModel(
  code = nim_code, 
  constants = list( M = M, Ne = 50 + 1 ),
  inits = list( beta = rep(0, 50 + 1), sigma = 1, delta = 0, 
